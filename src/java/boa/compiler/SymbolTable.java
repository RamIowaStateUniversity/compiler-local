...
public class SymbolTable {
	...
	static {
		...
		globalFunctions.addFunction("currentTime", new BoaFunction(new BoaInt(), new BoaType[] { }, "System.currentTimeMillis()"));
		...
		globalFunctions.addFunction("traverse", new BoaFunction(new BoaAny(), new BoaType[] { new BoaScalar(), new TraversalKindProtoMap(), new BoaTraversal(), new BoaFixP() }, "${2}.traverse(${0},${1},${3})"));
